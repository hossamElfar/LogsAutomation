...
public class DBTablePrinter {
     ...
     */
    public static void printTable(Connection conn, String tableName) throws ParseException {
     ...
     */
    public static void printTable(Connection conn, String tableName, int maxRows) throws ParseException {
     ...
     */
    public static void printTable(Connection conn, String tableName, int maxRows, int maxStringColWidth) throws ParseException {
        if (conn == null) {
        ...
        try {
            ...
            printResultSet(rs, maxStringColWidth, null, "", "", false);
     ...
     * @param isHourly
     */
    public static void printResultSetAndBlockIps(ResultSet rs, DBHandler dbHandler, String threshold, String startDate, boolean isHourly) throws ParseException {
        printResultSet(rs, DEFAULT_MAX_TEXT_COL_WIDTH, dbHandler, threshold, startDate, isHourly);
    }
     ...
     * @param isHourly
     */
    public static void printResultSet(ResultSet rs, int maxStringColWidth, DBHandler dbHandler, String threshold, String startDate, boolean isHourly) throws ParseException {
        try {
            if (rs == null) {
            ...
            while (rs.next()) {
                ...
                try {
                    dbHandler.blockIps(rs.getString("ip"), threshold, startDate, isHourly);
                } catch (Exception e) {
